...
func (s *Server) readString(q url.Values, key string, defaultValue string) string {
...
func (s *Server) readInt(q url.Values, key string, defaultValue int, v *validator.Validator) int {
	str := q.Get(key)
	if str == "" {
		return defaultValue
	}
